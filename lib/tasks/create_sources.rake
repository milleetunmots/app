task create_source: :environment do
  Source.find_or_create_by(name: 'CAF Paris', channel: 'caf', department: 75)
  Source.find_or_create_by(name: 'CAF 93', channel: 'caf', department: 93)
  Source.find_or_create_by(name: 'CAF Moselle', channel: 'caf', department: 57)
  Source.find_or_create_by(name: 'CAF Loiret', channel: 'caf', department: 45)
  Source.find_or_create_by(name: 'CAF 78', channel: 'caf', department: 78, comment: 'Pas encore partenaire')
  ...
  Source.find_or_create_by(name: 'Mon entourage', channel: 'bao')
