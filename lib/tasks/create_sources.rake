task create_source: :environment do
  ...
  Source.find_or_create_by(name: 'PMI Val de Saône Dombes', channel: 'pmi', department: 01)
  Source.find_or_create_by(name: "PMI Plaine de l'Ain Côtière", channel: 'pmi', department: 01)
  Source.find_or_create_by(name: 'PMI Bugey Pays de Gex', channel: 'pmi', department: 01)
  Source.find_or_create_by(name: 'PMI Bresse Revermont', channel: 'pmi', department: 01)
