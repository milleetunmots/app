  ...
  config.namespace :admin do |admin|
    admin.build_menu :utility_navigation do |menu|
      menu.add id: 'current_user',
               ...
               url: -> { current_admin_user.user_role.in?(%w[caller animator]) && current_admin_user.email.in?(ENV['BETA_TEST_CALLERS_EMAIL'].to_s.split) ? admin_reglages_path : admin_admin_user_path(current_admin_user) },
