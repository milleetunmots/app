class Child
  ...
  class CreateService
    ...
    def send_form_by_sms
      ...
      eval25_message = "1001mots : Bonjour, votre inscription au programme 1001mots est confirmée. Il n'y a pas de nouvel accompagnements pendant l'été, votre accompagnement commencera donc à la rentrée. A bientôt !"
