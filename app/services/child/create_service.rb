class Child
  ...
  class CreateService
    ...
    def send_form_by_sms
      ...
      return if @registration_origin == 2 && ENV['CAF_SUBSCRIPTION'].present?
      ...
      SpotHit::SendSmsService.new([@child.parent1_id], Time.zone.now.to_i, message).call if @registration_origin == 4
