...
class Child < ApplicationRecord
  ...
  REGISTRATION_SOURCES = %w[caf pmi friends therapist nursery doctor other].freeze
  PMI_LIST = %w[trappes plaisir orleans orleans_est montargis gien pithiviers sarreguemines forbach mantes_la_jolie].freeze
