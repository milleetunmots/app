...
#  calendly_initial_booking_dates      :jsonb
...
class Parent < ApplicationRecord
  ...
  MONTARGIS_POSTAL_CODE = %w[45110 45120 45200 45210 45220 45260 45270 45320 45490 45680 45700 49800 77460 77570].freeze
  AULNAY_SOUS_BOIS_POSTAL_CODE = %w[93600].freeze
  PARIS_20_EME_POSTAL_CODE = %w[75020].freeze
  BONDY_POSTAL_CODE = %w[93140].freeze
  GIEN_POSTAL_CODE = %w[45290 45500 45720 45250 45230].freeze
  ...
  scope :by_instagram_user_in, ->(value) {
  ...
  scope :by_instagram_follower_in, ->(value) {
    joins("INNER JOIN children ON children.parent1_id = parents.id OR children.parent2_id = parents.id")
    .joins("INNER JOIN child_supports ON child_supports.id = children.child_support_id")
  ...
  def self.ransackable_scopes(_auth_object = nil)
    super + %i[by_instagram_user_in by_instagram_follower_in]
  end
