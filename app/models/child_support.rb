...
class ChildSupport < ApplicationRecord
  ...
  CALL_RECORDING_CONSENT_OPTIONS = %w[0_yes 1_no no_clear_answer].freeze
  ...
  validates :call_recording_consent, inclusion: { in: CALL_RECORDING_CONSENT_OPTIONS, allow_blank: true }
