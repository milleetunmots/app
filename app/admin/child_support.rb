ActiveAdmin.register ChildSupport do
  ...
  action_item :actions, only: :show do
    dropdown_menu 'Actions' do
      ...
      item "Envoyer un message de désistement à la famille", %i[send_stop_support_message admin child_support], { data: { confirm: 'Je confirme vouloir envoyer un message de désistement à cette famille' }, method: 'GET' }
    end
  end
