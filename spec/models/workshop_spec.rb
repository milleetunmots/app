...
RSpec.describe Workshop, type: :model do
  ...
  describe ".set_workshop_participation" do
    ...
    context "create workshop_participation for each parent invited" do
      ...
      let!(:second_excluded_parent) { FactoryBot.create(:parent, is_excluded_from_workshop: true, postal_code: 75020) }
      ...
      let!(:workshop) { FactoryBot.create(:workshop, parents: [first_child.parent1, first_excluded_parent ], workshop_land: 'Paris 20 eme') }
