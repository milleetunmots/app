...
RSpec.describe ChildSupport, type: :model do
  ...
  let_it_be(:first_family, reload: true) { FactoryBot.create(:family, parent1: first_parent, parent2: third_parent)}
  let_it_be(:second_family, reload: true) { FactoryBot.create(:family, parent1: second_parent, parent2: fourth_parent)}
  let_it_be(:third_family, reload: true) { FactoryBot.create(:family, parent1: first_parent)}
  ...
  let_it_be(:first_child_support, reload: true) { first_family.child_support }
  let_it_be(:second_child_support, reload: true) { second_family.child_support }
  let_it_be(:third_child_support, reload: true) { third_family.child_support }
  ...
  describe "#without_supporter" do
    context "returns" do
      it "Child_support without supporter" do
        expect(ChildSupport.without_supporter).to match_array [first_child_support, second_child_support, third_child_support]
      end
    end
  end
