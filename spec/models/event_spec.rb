...
RSpec.describe Event, type: :model do
  before(:each) do
    allow(Child::AddToGroupService).to receive(:new).and_return(double(call: nil))
    ...
    @group = FactoryBot.create(:group, started_at: Date.today.next_occurring(:monday), expected_children_number: 0)
