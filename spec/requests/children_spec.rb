  ...
  describe "#create" do
    context "when params are valid" do
      ...
      it "redirects to created page with right sms_url_form" do
        expect(response).to redirect_to(created_child_path(sms_url_form: "#{ENV['TYPEFORM_URL']}#child_support_id=#{Child.last.child_support.id}", child_under_four_months: birthdate > 4.months.ago, youngest_child_under_twenty_four_months: birthdate > 24.months.ago))
      end
    end
